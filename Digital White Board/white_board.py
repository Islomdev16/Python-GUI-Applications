...
Button(root, image=eraser, bg="#f2f3f5", command=new_canvas).place(x=30, y=440)

colors = Canvas(root, bg="#ffffff", width=37, height=370, bd=0)
...
def display_pallete():
    ...
    id = colors.create_rectangle((10, 340, 30, 360), fill="yellow")
