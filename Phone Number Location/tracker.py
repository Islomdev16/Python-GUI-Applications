...
from pyparsing import White, null_debug_action
...
entry = StringVar()
enter_number = Entry(root, textvariable=entry, width=17, bd=0, highlightcolor="white", highlightbackground="white", font=("arial", 20), justify="center")
